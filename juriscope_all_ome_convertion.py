...
sample_names=['Melting_in_GUV_no_anch','Melting_in_GUV_2uM_anch','Bulk_no_anch','Bulk_2uM_anch']
...
interval_time=np.array([2000]) #  total time for each interval, same order as interval
